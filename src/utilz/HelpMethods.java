...
public class HelpMethods {
	...
	public static boolean IsBulletHittingLevel(Bullet b, int[][] lvlData) {
        ...
        public static boolean IsEntityInToxic(Rectangle2D.Float hitbox, int[][] lvlData) {
	...
	public static boolean CanSentryGunSeePlayer(int[][] lvlData, Rectangle2D.Float firstHitbox, Rectangle2D.Float secondHitbox, int yTile) {
